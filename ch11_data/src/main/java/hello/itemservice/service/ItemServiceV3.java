...
import hello.itemservice.repository.vvv222.ItemRepository;
...
public class ItemServiceV3 implements ItemService{
    ...
    public List<Item> findItems(ItemSearchCond itemSearch) {
        return itemSearchQueryRepository.findAll(itemSearch);
    }
}
